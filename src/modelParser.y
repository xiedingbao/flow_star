...
|
HYBRID '{' hybrid '}' TARGET '{' IDENT '}' //DFS based path-oriented style check, Dingbao Xie
{
...
check_path:CHECKPATH '{' PATH '}'{ 
	printf("Check path: %s\n",$3->c_str());
	$$ = $3;
	if(!hybridProblem.setPath(*$3)){
